...
<body class="text-white bg-black">
    <header>
        <div class="backdrop-blur-[2px] flex justify-evenly flex-col h-[100dvh] md:h-full">
            <nav class="hidden md:block">
                <ul class="flex justify-center fixed bacdrop-md bg-gray-500 w-full">
                    <li class="button-nav py-2.5"><a href="#" class="border py-2.5 px-5 button-nav">colors</a></li>
                    <li class="button-nav py-2.5"><a href="#" class="border py-2.5 px-5 button-nav">Gradinets</a></li>
                    <li class="button-nav py-2.5"><a href="#" class="border py-2.5 px-5 button-nav">Fonts</a></li>
            ...
            <div class="w-full h-full flex flex-col justify-around items-center p-5">
                ...
                <div class="border text-center font-normal p-2 md:p-5 backdrop-blur-[200px] bg-gray-800/80">
    ...
    <main>
        ...
        <section id="colors" class="p-5">
            ...
            <div class="flex flex-col items-center gap-2 md:flex-row justify-center md:mt-5 w-full">
                ...
                <input type="text" class="px-2 block lg:hidden rounded-md outline-none" placeholder="Ingresa el codigo HEXA o RGB" id="inputCodeColor">
                <input type="color" class="hidden lg:block" id="inputBoxColor">
                <div class="md:mx-14">
                    <button class="w-full text-base lg:text-lg px-2 border bg-gray-500 rounded-md">Crear Color</button>
                </div>
            </div>
            <!--* container  -->
        ...
        <section id="fonts" class="p-5">
            ...
            <div class="flex justify-center items-center py-2">
                <div class="flex flex-col items-center justify-center w-full gap-2 md:flex-row lg:gap-6">
                    ...
                    <button class="md:w-1/7 text-base lg:text-lg px-2 border bg-gray-500 rounded-md">Subir Font</button>
                </div>
            </div>
            <div class="">
