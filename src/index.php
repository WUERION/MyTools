...
<body class="h-full [background:radial-gradient(100%_200%_at_50%_5%,#000_20%,#63e_100%);] lg:[background:radial-gradient(100%_500%_at_50%_5%,#000_40%,#63e_120%);]">
    ...
    <main>
        ...
        <section class="my-32 p-2.5">
            ...
            <div>
                <a href="colors.php" class="text-white text-base ml-5 lg:text-lg hover:text-cyan-hover">Ver más...</a>
            </div>
        </section>
        <section class="my-32 p-2.5">
            <div>
            ...
            <div>
                <a href="gradient.php" class="text-white text-base ml-5 lg:text-lg hover:text-cyan-hover">Ver más...</a>
            </div>
        </section>
        <section class="my-32 p-2.5">
            <div>
            ...
            <div>
                <a href="fonts.php" class="text-white text-base ml-5 lg:text-lg hover:text-cyan-hover">Ver más...</a>
            </div>
        </section>
        <section class="my-32 p-2.5">
            <div>
