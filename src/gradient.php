...
<head>
    ...
    <title>My tools | gradients</title>
...
<body class="h-dvh [background:radial-gradient(100%_200%_at_50%_5%,#000_20%,#63e_100%);] lg:[background:radial-gradient(100%_500%_at_50%_5%,#000_40%,#63e_120%);]">
    <header class="fixed top-1 w-full flex items-center justify-center p-2.5 my-8">
        <nav class="w-full">
    ...
    <main>
        ...
        <div class="flex items-center justify-center my-5">
            <div class="p-5 lg:w-1/2">
                <h2 class="text-white text-center text-3xl">Gradientes</h2>
                <div class="flex items-center justify-center my-32">
                    <h1 class="text-white text-center text-base lg:text-xl">Aquí encontrasras todos los gradientes que
                        suelo utilizar en mis proyectos</h1>
                </div>
            </div>
        </div>
        <form action="" method="get" class="flex flex-col md:flex-row items-center justify-center gap-5">
            <input type="text" placeholder="RGB o HEXA" id="firstColor" class="text-white text-base p-1 border-b-2 bg-transparent outline-none placeholder:text-cyan-hover hover:border-cyan-hover focus:border-cyan-hover">
            <input type="text" placeholder="DEG" id="deg" class="text-white text-base p-1 border-b-2 bg-transparent outline-none placeholder:text-cyan-hover hover:border-cyan-hover focus:border-cyan-hover">
            <input type="text" placeholder="RGB o HEXA" id="secondColor" class="text-white text-base p-1 border-b-2 bg-transparent outline-none placeholder:text-cyan-hover hover:border-cyan-hover focus:border-cyan-hover">
            <input type="button" value="Crear gradiente" id="bntGradient" class="text-white text-base p-1 border-b-2 hover:cursor-pointer hover:border-cyan-hover">
        </form>
        <section class="grid grid-cols-2 lg:grid-cols-4 gap-5 p-5" id="container">
            <div class="card">
                <p class="codeColor">45deg, #00ffff, #a3e635</p>
                <div class="boxColor bg-gradient-to-tr from-cyan-500 to-lime-400"></div>
