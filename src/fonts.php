    ...
    <main>
        ...
        <div class="flex items-center justify-center my-5">
            <div class="p-5 lg:w-1/2">
                <h2 class="text-white text-center text-3xl">Fuentes</h2>
                <div class="flex items-center my-32">
                    <h1 class="text-white text-center text-base lg:text-xl">Aquí encontrasras todas las fuentes que suelo utilizar en mis proyectos</h1>
                </div>
            </div>
        </div>
        <form action="" method="get" class="flex flex-col md:flex-row items-center justify-center gap-5">
            <input type="url" placeholder="URL" id="urlFont" name="urlFont" required class="text-white p-1 border-b-2 bg-transparent outline-none placeholder:text-cyan-hover hover:border-cyan-hover focus:border-cyan-hover">
            <input type="text" placeholder="Name" id="nameFont" name="nameFont" required class="text-white p-1 border-b-2 bg-transparent outline-none placeholder:text-cyan-hover hover:border-cyan-hover focus:border-cyan-hover">
            <input type="button" value="Crear funete" id="createFont" class="text-white text-base p-1 border-b-2 bg-transparent hover:border-cyan-hover">
        </form>
        <section class="grid grid-cols-2 lg:grid-cols-4 gap-5 p-5" id="container">
            <div class="card">
                <div class="container">
                    <h3 class="nameFont">MuseoModerno</h3>
                    <p class="textFont">A, a, B, b, C, c, 0, 1, 2, 3, 4, 5</p>
                    <button class="copyFont">Copy</button>
                </div>
            </div>
        </section>
    </main>
